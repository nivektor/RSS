  ...
  <body>
	<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container">
			<div class="navbar-header">
				...
				<button type="button" onclick="deleteListSaved()" id="delete-saved" class="glyphicon glyphicon-thumbs-down btn btn-default btn-lrg pull-right"> Delete</button>
			</div>
			<div class="collapse navbar-collapse">
				...
				<ul class="nav navbar-nav">
					<!-- <li><a href="saved.php">Saved Articles</a></li> -->
					<?php $app->getFeedList(); ?>
				</ul>
			</div> <!--/.nav-collapse -->
		</div>
	...
	<div class="container">
		<div>
			...
			<?php $app->getArticleList($_GET, 'saved'); ?>
		</div>
	</div><!-- /.container -->
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<button type="button" onclick="deleteSavedItem()" id="delete" class="glyphicon glyphicon-thumbs-down btn btn-default btn-lrg"> Delete</button> 
				</div>
			</div>
		</div>
	</div> -->
